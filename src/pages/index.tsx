      ...
      {isLoading ? (
        ...
        <div>
          ...
          <div className="container lg:px-56 max-[500px]:px-5 pt-20 flex flex-col	">
            <span className="fade-in text-transparent text-lg bg-clip-text bg-gradient-to-br from-purple-600 to-blue-500">
              Hi, my name is
            </span>
            <span className="max-[500px]:text-5xl text-8xl text-white mb-5 fade-in" style={{transitionDelay:"1s"}}>
              Sukhjeet Singh.
            </span>
            <span className="max-[500px]:text-2xl text-4xl text-gray-400 fade-in">
              I build things for the
              <span className="text-transparent bg-clip-text bg-gradient-to-br from-purple-600 to-blue-500">
                {" cross platform."}
              </span>
            </span>
            <span className="max-[500px]:text-sm text-xl text-gray-400 fade-in">
